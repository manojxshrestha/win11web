...
// systeminfo command
export async function systeminfo(args: string[], session: TerminalSession): Promise<ExecutionResult> {
  let output = '\r\n';
...
// whoami command
export async function whoami(args: string[], session: TerminalSession): Promise<ExecutionResult> {
