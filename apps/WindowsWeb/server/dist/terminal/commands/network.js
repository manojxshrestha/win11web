...
exports.getmac = exports.hostname = exports.nbtstat = exports.getNetConnectionProfile = exports.netsh = exports.net = exports.arp = exports.getNetRoute = exports.routePrint = exports.getNetUDPEndpoint = exports.getNetTCPConnection = exports.netstat = exports.resolveDnsName = exports.nslookup = exports.pathping = exports.tracert = exports.testNetConnection = exports.testConnection = exports.ping = exports.getNetAdapter = exports.getNetIPAddress = exports.ipconfig = void 0;
// ============================================================================
// IP Configuration & Adapter Commands
// ============================================================================
async function ipconfig(args, session) {
...
async function getNetIPAddress(args, session) {
    let output = '\r\n';
...
exports.getNetIPAddress = getNetIPAddress;
// Get-NetAdapter - PowerShell command
async function getNetAdapter(args, session) {
    let output = '\r\n';
...
exports.getNetAdapter = getNetAdapter;
// ============================================================================
// Connectivity Testing Commands
// ============================================================================
async function ping(args, session) {
...
async function testConnection(args, session) {
    if (args.length === 0) {
        return {
...
async function testNetConnection(args, session) {
    if (args.length === 0) {
        return {
...
// tracert command
async function tracert(args, session) {
    if (args.length === 0) {
        return {
...
// pathping command
async function pathping(args, session) {
    if (args.length === 0) {
        return {
...
exports.pathping = pathping;
// ============================================================================
// DNS Commands
// ============================================================================
// nslookup command
async function nslookup(args, session) {
    if (args.length === 0) {
        // Interactive mode
        let output = '\r\n';
...
async function resolveDnsName(args, session) {
    if (args.length === 0) {
        return {
...
exports.resolveDnsName = resolveDnsName;
// ============================================================================
// Active Connections & Ports
// ============================================================================
// netstat command
async function netstat(args, session) {
...
async function getNetTCPConnection(args, session) {
    let output = '\r\n';
...
exports.getNetTCPConnection = getNetTCPConnection;
// Get-NetUDPEndpoint - PowerShell command
async function getNetUDPEndpoint(args, session) {
    let output = '\r\n';
...
exports.getNetUDPEndpoint = getNetUDPEndpoint;
// ============================================================================
// Routing & ARP Commands
// ============================================================================
// route print command
async function routePrint(args, session) {
    let output = '\r\n';
    output += '===========================================================================\r\n';
...
exports.routePrint = routePrint;
// Get-NetRoute - PowerShell command
async function getNetRoute(args, session) {
    let output = '\r\n';
...
exports.getNetRoute = getNetRoute;
// arp command
async function arp(args, session) {
    const showAll = args.includes('-a');
    let output = '\r\n';
...
// ============================================================================
async function net(args, session, fs) {
    if (args.length === 0) {
        return {
...
exports.net = net;
function handleNetShare(args, session, fs) {
...
function handleNetUse(args, session, fs) {
...
function handleNetView(args, session) {
...
function handleNetConfig(args, session) {
    return {
...
// ============================================================================
// netsh command
async function netsh(args, session) {
    if (args.length === 0) {
        return {
...
exports.netsh = netsh;
function handleNetshAdvFirewall(args, session) {
...
function handleNetshInt(args, session) {
...
async function getNetConnectionProfile(args, session) {
    let output = '\r\n';
    output += 'Name             : Network\r\n';
    output += 'InterfaceAlias   : Ethernet\r\n';
    output += 'InterfaceIndex   : 3\r\n';
...
exports.getNetConnectionProfile = getNetConnectionProfile;
// nbtstat command
async function nbtstat(args, session) {
    if (args.length === 0) {
        return {
...
// getmac command
async function getmac(args, session) {
