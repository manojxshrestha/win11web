...
// Animation variants for Quick Settings panel
const panelVariants = {
	hidden: {
		opacity: 0,
		y: -10,
...
export function QuickSettings() {
	...
	const quickSettingsDisclosure = useDisclosure();

	return (
		<Popover gutter={16} offset={[-95, 16]} placement="top" {...quickSettingsDisclosure}>
			<PopoverTrigger>
				<HStack
					_hover={{
						background: 'hoverBg',
			...
			<Portal>
				<AnimatePresence>
					{quickSettingsDisclosure.isOpen && (
						<motion.div
							initial="hidden"
							animate="visible"
							exit="exit"
